...
class App {
    ...
    public menu(): void {
        try {
            ...
            let conta1 = new Conta(1, "123", 50); // Saldo inicial: 50
            let conta2 = new Conta(2, "456", 200); // Saldo inicial: 200

            this.banco.inserirConta(conta1);
            this.banco.inserirConta(conta2);

            console.log("Contas criadas:");
            console.log(`Conta 1 - Número: ${conta1.numero}, Saldo: ${conta1.saldo}`);
            console.log(`Conta 2 - Número: ${conta2.numero}, Saldo: ${conta2.saldo}`);

            console.log("\nTentando transferir R$100 da Conta 1 para a Conta 2 (saldo insuficiente):");
            this.banco.transferir("123", "456", 100); // Lançará exceção
        } catch (error) {
            console.error("Erro capturado no App.menu():", error.message);
        }
    }
}
...
const conta1 = new Conta(1, "123", 50);
const conta2 = new Conta(2, "456", 200);

console.log("Saldo inicial da conta 1:", conta1.saldo);
console.log("Saldo inicial da conta 2:", conta2.saldo);
...
console.log("Saldo final da conta 1:", conta1.saldo);
console.log("Saldo final da conta 2:", conta2.saldo);
